...
Dictionary<string, Reaction> production = new Dictionary<string, Reaction>();
...
long FindTrillionOreFuel(long lowerBound, long upperBound)
{
...
long GetOreRequirementForFuel(long fuel)
{
...
class Reaction
{
    ...
    (int count, string reagent) Parse(string fragment)
    {
