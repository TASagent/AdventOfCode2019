...
long gcd = AoCMath.GCD(xPeriod, yPeriod);
gcd = AoCMath.GCD(gcd, zPeriod);

long lcmXY = (xPeriod / AoCMath.GCD(xPeriod, yPeriod)) * yPeriod;
long total = (lcmXY / AoCMath.GCD(lcmXY, zPeriod)) * zPeriod;
